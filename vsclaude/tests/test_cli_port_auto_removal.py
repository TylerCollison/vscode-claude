...
def test_cli_start_help_does_not_contain_port_auto_flag():
    ...
    # Add vsclaude directory to Python path
    ...
    # Mock sys.argv to simulate 'vsclaude start --help' command
    original_argv = sys.argv
    sys.argv = ['vsclaude', 'start', '--help']
    ...
    try:
        ...
        sys.path.remove(os.path.join(os.getcwd(), 'vsclaude'))
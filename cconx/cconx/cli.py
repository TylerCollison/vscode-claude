...
def start_command(args):
    """
    Start a new ClaudeConX Docker instance.
...
def status_command(args):
    """
    Show status of all ClaudeConX Docker instances.
    ...
    for instance_dir in instances_dir.iterdir():
        if instance_dir.is_dir():
            ...
            if config_file.exists():
                ...
                container_name = f"cconx-{config['name']}"
...
def stop_command(args):
    """
    Stop a running ClaudeConX Docker instance.
...
def delete_command(args):
    """
    Delete a ClaudeConX Docker instance and its configuration.
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="ClaudeConX Docker Management")
